...
namespace AppBanHang.Services.Interfaces
{
    public interface IReceiptInforService
    {
        ...
        ReceiptInfo UpdateReceiptInfo(int reReceiptId, int productId, ReceiptInfo receiptInfo);
        ...
        Task<ReceiptInfo> UpdateReceiptInfoAsync(int receiptId, int productId, ReceiptInfo receiptInfo);
